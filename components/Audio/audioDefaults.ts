...
export const SOUND_MANIFEST: SoundDefinition[] = [
  { id: "wind", bus: "Ambient", src: ["/audio/ambient/wind.ogg", "/audio/wind.mp3"], loop: true, baseVolume: 0.6, preload: true },
  { id: "birds", bus: "Ambient", src: ["/audio/ambient/birds.ogg", "/audio/birds.mp3"], loop: true, baseVolume: 0.6, preload: true },
  { id: "insects", bus: "Ambient", src: ["/audio/ambient/insects.ogg", "/audio/insects.mp3"], loop: true, baseVolume: 0.15, preload: true },
  ...
  { id: "bell", bus: "Environment", src: ["/audio/env/bell.ogg", "/audio/bell.mp3"], loop: false, baseVolume: 1, positional: { refDistance: 10, maxDistance: 100, rolloffFactor: 1 } },
...
//   { id: "bridge", bus: "Environment", src: ["/audio/env/bridge.ogg", "/audio/bridge.mp3"], loop: true, baseVolume: 0.4, positional: { refDistance: 6, maxDistance: 45, rolloffFactor: 1.5 } },
  ...
  { id: "theme", bus: "Music", src: ["/audio/music/theme.ogg", "/audio/sea2.mp3"], loop: true, baseVolume: 0.25, preload: true }
];
